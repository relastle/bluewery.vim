...
let s:b_green   = [10, '#236b64']
let s:b_yellow  = [11, '#DF7353']
let s:b_blue    = [12, '#5F9E9F']
...
function! s:build_palette() abort
  ...
  let col_base     = [s:b_white[1],   s:n_black[1], s:b_white[0],   s:n_black[0]]
  let col_edge     = [s:b_white[1],   s:b_yellow[1], s:b_white[0],   s:b_yellow[0]]
  let col_gradient = [s:b_white[1],   s:b_magenta[1], s:b_white[0],   s:b_magenta[0]]
