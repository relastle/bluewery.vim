...
" ::::::::::::::::::::::::::::::::::::::::::::::::...::
"
" File:       bluewery_text_writing.vim
...
function! s:build_palette() abort
  ...
  let l:col_edge     = bluewery#make_gui_term_pair_colors(s:b_white,   s:b_green)
  let l:col_gradient = bluewery#make_gui_term_pair_colors(s:b_black,   s:b_cyan)
  let l:col_nc       = bluewery#make_gui_term_pair_colors(s:b_white,   s:n_green)
  ...
  let l:col_replace  = bluewery#make_gui_term_pair_colors(s:b_black,   s:n_green)
  ...
  let l:col_warning  = bluewery#make_gui_term_pair_colors(s:n_white,   s:n_green)
...
let g:lightline#colorscheme#bluewery_text_writing#palette = s:build_palette()
